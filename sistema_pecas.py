...
def limpar_buffer():
    ...
    Evita que teclas digitadas anteriormente contaminem o próximo input.
    ...
    try:
        ...
        try:
            import termios  # Linux/Mac (só funciona em terminal real)
            termios.tcflush(sys.stdin, termios.TCIFLUSH)
        except Exception:
            pass  # Ignora se não for um terminal interativo
...
def main():
    ...
    while True:
        limpar_buffer()          # Limpa buffer antes de mostrar o menu
        exibir_menu()
        ...
        # Pausa entre operações — evita que teclas residuais contaminem o menu
